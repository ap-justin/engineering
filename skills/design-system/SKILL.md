...
<!-- vendored from `anthropics/knowledge-work-plugins` → `design` plugin (v1.2.0, sha 15898ec) → `skills/design-system`. Design-system audit/document/extend backing the `ux-designer` seat. Kept verbatim; re-sync: re-download from https://raw.githubusercontent.com/anthropics/knowledge-work-plugins/15898ec/design/skills/design-system/. -->
