...
<!-- vendored from `leonxlnx/taste-skill` (main, sha 7c397f2) → `skills/design-taste-frontend`. tasteskill anti-slop frontend pack backing the `design-director` + `taste-reviewer` seats. NOTE: upstream is leonxlnx/taste-skill (MIT), NOT mattpocock/skills. Kept verbatim; re-sync: re-download from https://raw.githubusercontent.com/leonxlnx/taste-skill/main/skills/taste-skill/. -->
