...
<!-- vendored from `coreyhaines31/marketingskills` (main, sha 286d371) → `skills/cro`.
     ...
     the mattpocock pack). Backs the `conversion-copywriter` seat — optimizing the pages/forms
     that ship in the build, NOT paid-channel/campaign optimization. Kept verbatim; cross-skill
